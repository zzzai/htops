...
主项总钟数：7个",
  ...
  it("passes through boundary failure classes in semantic quality summary", async () => {
    const getSemanticQualitySummary = vi.fn().mockResolvedValue({
      windowHours: 24,
      totalCount: 8,
      successCount: 3,
      ...
      fallbackRate: 0,
      topFailureClasses: [
        { failureClass: "missing_cost_model_contract", count: 4 },
        { failureClass: "unsupported_external_research", count: 2 },
      ],
      topAnalysisFrameworks: [],
      topRouteUpgrades: [],
      optimizationBacklog: [
        ...
        },
        {
          ...
          recommendedAction: "分流到 HQ 外部研究 lane。",
          priority: "medium",
        },
      ],
      sampleCandidates: [
      ...
      listAnalysisDeadLetters: vi.fn().mockResolvedValue([
        {
          ...
          reason:
            "[2026-04-13T07:57:31.987Z] [AiBotSDK] [WARN] Reply ack error: reqId=aibot_send_msg_REDACTED_1, errcode=93006, errmsg=invalid chatid, hint: [REDACTED], from ip: 127.0.0.1, more info at https://open.work.weixin.qq.com/devtool/query?e=93006\n[object Object]\n",
        ...
        },
        {
          ...
          deadLetterScope: "subscriber",
          reason:
            "[2026-04-13T07:51:01.610Z] [AiBotSDK] [WARN] Reply ack error: reqId=aibot_send_msg_REDACTED_2, errcode=93006, errmsg=invalid chatid, hint: [REDACTED], from ip: 127.0.0.1, more info at https://open.work.weixin.qq.com/devtool/query?e=93006\n[object Object]\n",
