...
function resolveTouchWindow(params: {
  ...
  if (
    ...
    return {
      ...
      touchWindowMatchScore: round(params.timePreferenceConfidenceScore * 0.6, 4),
...
export function buildMemberReactivationStrategiesForBizDate(params: {
  ...
  return params.featureRows
    ...
    .map((row) => {
      ...
      const strategyPriorityScore = resolveStrategyPriorityScore({
