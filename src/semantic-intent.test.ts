...
describe("resolveSemanticIntent", () => {
  ...
  it("routes AI physical model definition asks into the meta lane instead of store clarification", () => {
    const intent = resolveSemanticIntent({
      config,
  ...
  it("routes store world-model build asks into the meta lane instead of store clarification", () => {
    const intent = resolveSemanticIntent({
      config,
      text: "门店的世界模型 如何搭建",
      now,
  ...
  it("routes business architecture design asks into the meta lane instead of store clarification", () => {
    const intent = resolveSemanticIntent({
      config,
      text: "门店组织架构怎么设计",
      now,
