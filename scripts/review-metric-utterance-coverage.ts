...
} from "../src/metric-utterance-coverage-builder.js";
import samples from "../src/metric-user-utterance-samples.json" with { type: "json" };
import type { MetricUserUtteranceSample } from "../src/metric-route-eval-fixture-builder.js";
...
async function main(): Promise<void> {
  ...
  console.log(JSON.stringify(filterMetricUtteranceCoverage(coverage, args.filter), null, 2));
}
