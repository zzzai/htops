...
} from "../src/hxy-brand-master-plan.js";
import { readPersonalKnowledgeIndex, searchPersonalKnowledgeChunks } from "../src/personal-knowledge.js";
...
function parseArgs(argv: string[]): Args {
  ...
  const args: Args = {
    draftPath: path.join(rootDir, "knowledge", "hxy", "structured", "brand-planning-draft.json"),
    brandIndexPath: path.join(rootDir, "knowledge", "brand", "index.json"),
    outputDir: path.join(rootDir, "knowledge", "hxy", "structured"),
  };
