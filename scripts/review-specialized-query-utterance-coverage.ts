...
} from "../src/specialized-query-utterance-coverage-builder.js";
import samples from "../src/specialized-query-utterance-samples.json" with { type: "json" };
import type { SpecializedQueryUtteranceSample } from "../src/specialized-query-route-eval-fixture-builder.js";
...
async function main(): Promise<void> {
  ...
  console.log(JSON.stringify(filterSpecializedQueryUtteranceCoverage(coverage, args.filter), null, 2));
}
