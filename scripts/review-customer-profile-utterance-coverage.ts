...
} from "../src/customer-profile-utterance-coverage-builder.js";
import samples from "../src/customer-profile-utterance-samples.json" with { type: "json" };
import type { CustomerProfileUtteranceSample } from "../src/customer-profile-route-eval-fixture-builder.js";
...
async function main(): Promise<void> {
  ...
  console.log(JSON.stringify(filterCustomerProfileUtteranceCoverage(coverage, args.filter), null, 2));
}
